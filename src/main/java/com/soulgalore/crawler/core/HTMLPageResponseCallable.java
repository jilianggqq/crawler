...
public class HTMLPageResponseCallable implements Callable<HTMLPageResponse> {
	 ...
	 * @param followRedirectsToNewDomain
	 *            if true, follow redirects that lead to a different domain.
	 */
	public HTMLPageResponseCallable(CrawlerURL theUrl, HTMLPageResponseFetcher theFetcher, boolean fetchTheBody,
			Map<String, String> theRequestHeaders, boolean followRedirectsToNewDomain) {
